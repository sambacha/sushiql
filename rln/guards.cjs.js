...
var RegistrationEntity_possibleTypes = ['RegistrationEntity']
module.exports.isRegistrationEntity = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isRegistrationEntity"')
