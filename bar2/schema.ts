...
export type User_orderBy = 'id' | 'bar' | 'xSushi' | 'xSushiIn' | 'xSushiOut' | 'xSushiMinted' | 'xSushiBurned' | 'xSushiOffset' | 'xSushiAge' | 'xSushiAgeDestroyed' | 'sushiStaked' | 'sushiStakedUSD' | 'sushiHarvested' | 'sushiHarvestedUSD' | 'sushiOut' | 'sushiIn' | 'usdOut' | 'usdIn' | 'sushiOffset' | 'usdOffset' | 'createdAt' | 'createdAtBlock' | 'updatedAt' | 'updatedAtBlock'
...
export interface QueryRequest{
    ...
    subgraphError: _SubgraphErrorPolicy_},BarRequest]
    ...
    block?: (Block_height | null),
    /** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
    subgraphError: _SubgraphErrorPolicy_},HistoryRequest]
...
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => BarPromiseChain & {get: <R extends BarRequest>(request: R, defaultValue?: (FieldsSelection<Bar, R> | undefined)) => Promise<(FieldsSelection<Bar, R> | undefined)>}),
...
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => {get: <R extends BarRequest>(request: R, defaultValue?: FieldsSelection<Bar, R>[]) => Promise<FieldsSelection<Bar, R>[]>}),
...
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => HistoryPromiseChain & {get: <R extends HistoryRequest>(request: R, defaultValue?: (FieldsSelection<History, R> | undefined)) => Promise<(FieldsSelection<History, R> | undefined)>}),
...
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => {get: <R extends HistoryRequest>(request: R, defaultValue?: FieldsSelection<History, R>[]) => Promise<FieldsSelection<History, R>[]>}),
...
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => BarObservableChain & {get: <R extends BarRequest>(request: R, defaultValue?: (FieldsSelection<Bar, R> | undefined)) => Observable<(FieldsSelection<Bar, R> | undefined)>}),
    bars: ((args: {skip?: (Scalars['Int'] | null),first?: (Scalars['Int'] | null),orderBy?: (Bar_orderBy | null),orderDirection?: (OrderDirection | null),where?: (Bar_filter | null),
/** The block at which the query should be executed. Can either be an `{ number: Int }` containing the block number or a `{ hash: Bytes }` value containing a block hash. Defaults to the latest block when omitted. */
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => {get: <R extends BarRequest>(request: R, defaultValue?: FieldsSelection<Bar, R>[]) => Observable<FieldsSelection<Bar, R>[]>}),
    user: ((args: {id: Scalars['ID'],
/** The block at which the query should be executed. Can either be an `{ number: Int }` containing the block number or a `{ hash: Bytes }` value containing a block hash. Defaults to the latest block when omitted. */
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
...
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => HistoryObservableChain & {get: <R extends HistoryRequest>(request: R, defaultValue?: (FieldsSelection<History, R> | undefined)) => Observable<(FieldsSelection<History, R> | undefined)>}),
    histories: ((args: {skip?: (Scalars['Int'] | null),first?: (Scalars['Int'] | null),orderBy?: (History_orderBy | null),orderDirection?: (OrderDirection | null),where?: (History_filter | null),
/** The block at which the query should be executed. Can either be an `{ number: Int }` containing the block number or a `{ hash: Bytes }` value containing a block hash. Defaults to the latest block when omitted. */
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => {get: <R extends HistoryRequest>(request: R, defaultValue?: FieldsSelection<History, R>[]) => Observable<FieldsSelection<History, R>[]>}),
...
export interface UserPromiseChain{
    ...
    createdAt: ({get: (request?: boolean|number, defaultValue?: Scalars['BigInt']) => Promise<Scalars['BigInt']>}),
    createdAtBlock: ({get: (request?: boolean|number, defaultValue?: Scalars['BigInt']) => Promise<Scalars['BigInt']>}),
    updatedAt: ({get: (request?: boolean|number, defaultValue?: Scalars['BigInt']) => Promise<Scalars['BigInt']>}),
    updatedAtBlock: ({get: (request?: boolean|number, defaultValue?: Scalars['BigInt']) => Promise<Scalars['BigInt']>})
}
...
export interface UserObservableChain{
    ...
    createdAt: ({get: (request?: boolean|number, defaultValue?: Scalars['BigInt']) => Observable<Scalars['BigInt']>}),
    createdAtBlock: ({get: (request?: boolean|number, defaultValue?: Scalars['BigInt']) => Observable<Scalars['BigInt']>}),
    updatedAt: ({get: (request?: boolean|number, defaultValue?: Scalars['BigInt']) => Observable<Scalars['BigInt']>}),
    updatedAtBlock: ({get: (request?: boolean|number, defaultValue?: Scalars['BigInt']) => Observable<Scalars['BigInt']>})
}
